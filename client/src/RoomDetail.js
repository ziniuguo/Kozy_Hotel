                        ...
                        <Slider {...settings}>
                            {this.state.images.map(image => (
                                <div className="center-image">
                                    <h3><img className="Cover" style={{"height": "600px", "width": "1000px",}}
                                             src={image} alt="test"/></h3>
                                </div>
                            ))}
                        </Slider>
                    </div>
                            ...
                            <div className="float-container">
                                ...
                                <div className="Map">
                                    ...
                                    <iframe
                                        ...
                                        height={450} style={{width: '100%', border: 0}} allowFullScreen=""
                                                ...
                                                <div key={room.id}>
                                                    ...
                                                    <div>
                                                        <button className="bookButton"
                                                            // disabled={}
                                                                onClick={() => window.open("/booking/" + window.location.pathname.split('/').pop(), "_self")}>Book
                                                            Now
                                                        </button>
                                                    </div>
                                                </div>
